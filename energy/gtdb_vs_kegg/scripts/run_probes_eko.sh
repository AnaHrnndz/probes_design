...
#SBATCH --mem=32GB
#SBATCH --array=1-558
#SBATCH -e /home/plaza/projects/biorare/gtdb_vs_kegg/scripts/slurm/build_probes/build_eko_probes_%A_%a.err
#SBATCH -o /home/plaza/projects/biorare/gtdb_vs_kegg/scripts/slurm/build_probes/build_eko_probes_%A_%a.out
#SBATCH -t 07-00:00
#SBATCH -p long
...
fasta_in=$(cat '/home/plaza/projects/biorare/gtdb_vs_kegg/results/path2expanded_fastas.txt' | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
mapback_id=0.8
mapback_cov=0.8
main_outdir=/home/plaza/projects/biorare/gtdb_vs_kegg/results/eko_probes
