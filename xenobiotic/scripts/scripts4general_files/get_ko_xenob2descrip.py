...
"""
    Get xenobiotic ko to description json file
"""
...
for ko, pathways in ko2path_desc.items():
    for p, descriptions in pathways.items():
        ...
        if descriptions_info[1] == 'Xenobiotics_biodegradation_and_metabolism':
            if ko.startswith('K'):
...
with open('/home/plaza/projects/biorare/results/xenob_ko2path_descp.json', 'w') as f:
