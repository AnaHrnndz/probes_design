...
#SBATCH -c 1
#SBATCH --array=1-192
#SBATCH -e /home/plaza/projects/biorare/scripts/slurm/insilico/insilico_test_reciprocal_v2_%A_%a.err
#SBATCH -o /home/plaza/projects/biorare/scripts/slurm/insilico/insilico_test_reciprocal_v2_%A_%a.out
#SBATCH -t 01-00:00
#SBATCH -p medium

#####
#   Run Desing probes scripts
#   KO with reciprocal analysis
#####
...
fasta_in=$(cat '//home/plaza/projects/biorare/results/insilico_xenob/reciprocal_qcov08_v2/path2reciprocal_fastas.txt' | sed -n ${SLURM_ARRAY_TASK_ID}p)
...
mapback_id=0.8
mapback_cov=0.8
main_outdir=/home/plaza/projects/biorare/results/insilico_xenob/reciprocal_qcov08_v2/result_insilico_test
